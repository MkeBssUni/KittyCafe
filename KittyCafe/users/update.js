const findOne = (id) => {
    ...
    .then((data) => {
      ...
      document.getElementById("password").value = data.user[0].password;
      document.getElementById("id_role").value = data.user[0].id_role;
      document.getElementById("status").value = data.user[0].status;
      document.getElementById("email").value = data.user[0].email;
      document.getElementById("phone_number").value = data.user[0].phone_number;
    })
    .catch((error) => {
      console.log(error);
    });
